...
**d.grows.11** = \# days in growing season 2011 (start / end of gorwing season determined by sustained snow or frost) **GDD.grows.11** = \# growing degree days (Tbase=10C, Tmax capped at 30C) in growing season of 2011 
...
ggplot(clim.win, aes(x = year, y = d.snowpack, color = ID)) +
  ...
  theme_classic()
```
Figure 1. Comparison of the total days with snowpack in winter among sites sampled from elevational transect NK and HB. Grey solid lines indicate the change in days across years.
...
ggplot(clim.not.win, aes(x = year, y = avmaxminTJuly, color = ID)) +
  ...
  theme_classic()
```
Figure 2. Comparison of the mean July temperature (°C) among sites sampled from elevational transect NK and HB. Grey solid lines indicate the change across years from 2011 to 2013.
